...
public class EHBasedOnPriorityQueue implements EventsHolder {
    
    private Queue<Event> events = new PriorityQueue<Event>(1000, Event.ABSOLUT_ORDERER);
    ...
    @Override
    public NavigableSet<Event> nextSimultaneous() {
